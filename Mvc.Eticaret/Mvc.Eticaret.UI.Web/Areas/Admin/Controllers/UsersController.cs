...
namespace Mvc.Eticaret.UI.Web.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,LastName,Email,Telephone,Password,TCKN,IsActive,IsAdmin,CreateDate,CreateUserID,UpgdateDate,UpdateUserID")] User user)
        {
            if (ModelState.IsValid)
            {
