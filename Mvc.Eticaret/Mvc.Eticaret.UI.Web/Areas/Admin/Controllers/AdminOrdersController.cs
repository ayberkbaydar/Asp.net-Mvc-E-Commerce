...
namespace Mvc.Eticaret.UI.Web.Areas.Admin.Controllers
{
    public class AdminOrdersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTaxPrice,TotalDiscount,TotalPrice,CreateDate,CreateUserID,UpgdateDate,UpdateUserID")] Order order)
        {
            if (ModelState.IsValid)
            {
